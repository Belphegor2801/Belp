...
import 'package:social_media_app/screens/auth/login/login.dart';
      ...
      child: Column(
        children: [
          ...
          TextFormBuilder(
            ...
            nextFocusNode: viewModel.phonenumberFN,
          ),
          SizedBox(height: 20.0),
          TextFormBuilder(
            enabled: !viewModel.loading,
            ...
            focusNode: viewModel.phonenumberFN,
