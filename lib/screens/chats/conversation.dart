...
class Conversation extends StatefulWidget {
  ...
  const Conversation({required this.userId, required this.chatId, required this.newChat});
...
class _ConversationState extends State<Conversation> {
  ...
  void initState() {
    ...
    if (widget.newChat) {
      Provider.of<ConversationViewModel>(context, listen: false).setupFirstChat(widget.userId);
    }
