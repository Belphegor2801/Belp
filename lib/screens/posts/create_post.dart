...
class _CreatePostState extends State<CreatePost> {
            ...
            actions: [
              GestureDetector(
                onTap: () async {
                  ...
                  if (valid == ""){
                    bool success = await viewModel.uploadPosts(context);
                    if (success){
                      Navigator.pop(context);
                      viewModel.resetPost();
                    }
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: viewModel.imgLink != null
                      ? ImageSlider(
                        imageUrls: viewModel.imgLink!, 
                        onImageClicked: (i){}, 
                        onExpandClicked: (){},
                        type: viewModel.imgLink!.contains('.mp4')? 'online-video': 'online-images',
                      )
  ...
  checkImagesValid(BuildContext context, PostsViewModel viewModel){
    String valid = Validations.validateImages(value: viewModel.mediaUrl);
    return valid;
  }
}
