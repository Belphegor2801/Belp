...
class _ActivityItemsState extends State<ActivityItems> {
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.of(context).push(
            CupertinoPageRoute(
              builder: (_) => widget.activity!.type == "sendFriendRequest" || widget.activity!.type == "acceptFriendRequest"
  ...
  buildTextConfiguration() {
    if (widget.activity!.type == "like") {
      ...
      return "commented '${widget.activity!.commentData} in your post'";
    }else if (widget.activity!.type == "sendFriendRequest") {
      return "send you a friend request";
    }else if (widget.activity!.type == "acceptFriendRequest") {
